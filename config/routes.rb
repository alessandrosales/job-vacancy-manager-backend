Rails.application.routes.draw do
  namespace :api do
    namespace :v1 do
      ...
      post "auth/firebase", to: "auth/firebase_sessions#create"
      ...
      resources :resumes do
        resource :duplication, only: :create, controller: "resumes/duplications"
        get "compiled-export", to: "resumes/compiled_exports#show"
